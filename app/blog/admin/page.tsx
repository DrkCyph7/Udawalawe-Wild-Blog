  ...
  if (isAdmin === false) {
    return (
      <div className="min-h-screen bg-[#F5F5F0] flex flex-col items-center justify-center p-4">
        <h1 className="text-6xl md:text-8xl font-serif text-[#324b37] mb-6 tracking-tight">Access Denied</h1>
        <p className="text-lg md:text-xl text-[#526356] max-w-lg text-center mb-4">
          You do not have permission to view this page. Please log in with an administrator account to access the moderation queue.
        </p>
      </div>
    )
  }
