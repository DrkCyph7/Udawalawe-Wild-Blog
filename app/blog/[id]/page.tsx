...
export default async function PostDetailPage({ params }: Props) {
  ...
  try {
    ...
    if (docSnap.exists()) {
      ...
      // Private posts: server-side we just fetch and let the client guard.
      // The Firestore rules enforce read-level security. For SSR we check visibility:
      // public approved posts are visible to all, private ones fall through to notFound()
      // unless the client is the owner (handled via client-component guard on private posts)
      const isVisible =
